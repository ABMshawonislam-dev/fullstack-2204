...
function Product() {
    return (
        <div className='w-[320px] bg-white rounded-md'>
            <div className='p-2'>
                ...
                <Flex className="justify-between items-center">
                    ...
                    <button className='font-roboto font-medium text-base text-white bg-orange px-4 py-1 rounded-[4px] mt-4'>Add to card</button>
                </Flex>
            </div>
        </div>
    )
